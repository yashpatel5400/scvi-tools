...
python -u run_destVI.py --input-dir /home/ubuntu/simu_runs/run_B --sc-epochs 15 --st-epochs 2500
...
# Step 3: eval methods
# python -u benchmark.py --input-dir /home/ubuntu/simu_runs/run_B --model-subdir destvi --model-string DestVI
