...
from scvi.core.trainers.tree_inference import TreeTrainer
from ete3 import Tree

logger = logging.getLogger(__name__)


class CASCVI(RNASeqMixin, VAEMixin, ArchesMixin, BaseModelClass):
    """
    Cassiopeia + single-cell Variational Inference [Ouardini...]_.
    ...
    **model_kwargs
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        super(CASCVI, self).__init__(adata, use_cuda=use_cuda)
        self.model = TreeVAE(
        ...
        self._model_summary_string = (
            "CASCVI Model with the following params: \nn_hidden: {}, n_latent: {}, n_layers: {}, dropout_rate: "
